...
<div class="page">
    ...
    <table class="branding-table">
        <tr>
            <td width="120">
                <img src="{{ asset('assets/images/weShareSite.png') }}" class="logo" alt="Logo">
            </td>
    ...
    <table class="items-table mt-20">
        ...
        <tbody>
            <tr>
                ...
                <td>{{ $transaction->currency }} {{ $transaction->plan_price }}</td>
                <td>{{ $transaction->currency }} {{ $transaction->plan_price * $transaction->quantity }}</td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="totals-table">
        ...
        <tr>
            ...
            <td><strong>{{ $transaction->currency }} {{ ($transaction->plan_price * $transaction->quantity) + $transaction->vat }}</strong></td>
        </tr>
    </table>
