...
<div class="page">
    ...
    <table class="meta-table mt-10">
        ...
        <tr>
            ...
            <td>{{ ucfirst($transaction->transaction_source) }}</td>
        </tr>
    </table>
    ...
    <p class="mt-10">
        Sehr geehrte/r {{ $transaction->name }},<br><br>
    ...
    <table class="items-table mt-20">
        ...
        <tbody>
            <tr>
                ...
                <td>{{ $transaction->currency }}{{ number_format($transaction->price, 2) }}</td>
                <td>{{ $transaction->currency }}{{ number_format($transaction->price * $transaction->quantity, 2) }}</td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="totals-table">
        ...
        <tr>
            ...
            <td>{{ $transaction->currency }}{{ number_format($transaction->vat, 2) }}</td>
        </tr>
        <tr>
            <td class="label">Gesamtbetrag</td>
            <td><strong>
                {{ $transaction->currency }}
                {{ number_format(($transaction->price * $transaction->quantity) + $transaction->vat, 2) }}
            </strong></td>
        </tr>
    </table>
